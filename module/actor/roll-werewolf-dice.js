...
export async function rollWerewolfDice (numDice, actor, label = '', difficulty = 0, rageDice = 0, subtractWillpower = false, consumeRage = false, callback) {
  ...
  for (let i = 0, j = critSuccess; i < j; i++) {
    chatMessage = chatMessage + '<img src="systems/vtm5e/assets/images/werewolf-crit.png" alt="Normal Crit" class="roll-img normal-dice" />'
  }
  for (let i = 0, j = success; i < j; i++) {
    chatMessage = chatMessage + '<img src="systems/vtm5e/assets/images/werewolf-success.png" alt="Normal Success" class="roll-img normal-dice" />'
  }
  ...
  for (let i = 0, j = rageCritSuccess; i < j; i++) {
    chatMessage = chatMessage + '<img src="systems/vtm5e/assets/images/werewolf-red-crit.png" alt="Rage Crit" class="roll-img rage-dice" />'
  }
  for (let i = 0, j = rageSuccess; i < j; i++) {
    chatMessage = chatMessage + '<img src="systems/vtm5e/assets/images/werewolf-red-success.png" alt="Rage Success" class="roll-img rage-dice" />'
  }

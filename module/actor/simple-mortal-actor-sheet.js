...
export class MortalActorSheet extends CoterieActorSheet {
  ...
  static get defaultOptions () {
    return mergeObject(super.defaultOptions, {
      ...
      template: 'systems/vtm5e/templates/actor/simple-mortal-sheet.html',
      width: 800,
      height: 700,
      tabs: [{
  ...
  get template () {
    ...
    return 'systems/vtm5e/templates/actor/simple-mortal-sheet.html'
  }
  ...
  getData () {
    ...
    // Prepare items.
    if (this.actor.data.type === 'simpleMortal') {
